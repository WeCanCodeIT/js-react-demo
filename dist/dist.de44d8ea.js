...
parcelRequire = function (e, r, n, t) {
      ...
      return Object.defineProperties(e, {
        ...
        setState: {
          value: function value(n) {
            for (var r in n) {
              n.hasOwnProperty(r) && (e.state[r] = n[r]);
            }

            return t(e, e.elem), e.elem;
          }
        },
        render: t
      }), e;
  ...
  "lY9v": [function (require, module, exports) {
    var e = require("./component"),
        t = e.component,
        o = t(function () {
      for (var e = "", t = 0; t < this.state.todos.length; t++) {
        var o = this.state.todos[t],
            a = o.completed ? "checked" : "";
        e += '<label><input type="checkbox" value="' + o.item + '" ' + a + ">" + o.item + "</label>";
      }
  ...
  "Focm": [function (require, module, exports) {
    ...
    p.render(this, document.querySelector("#app"));
  }, {
    "./App": "lY9v"
  }]
}, {}, ["Focm"], null);
